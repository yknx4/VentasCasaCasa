...
import com.arekar.android.ventascasacasa.helpers.NotificationHelper;
import com.arekar.android.ventascasacasa.imgurmodel.ImageResponse;
import com.arekar.android.ventascasacasa.imgurmodel.ImgurAPI;
import com.arekar.android.ventascasacasa.imgurmodel.Upload;
import com.arekar.android.ventascasacasa.utils.NetworkUtils;
...
public class UploadService {
    ...
    public void Execute(Upload upload, Callback<ImageResponse> callback) {
        ...
        restAdapter.create(ImgurAPI.class).postImage(
                ...
                upload.albumId,
                null,
                new TypedByteArray("image/*", Methods.getBytes(upload.image)),
