 ...
 */
package com.arekar.android.ventascasacasa.transitions;
...
public class RevealTransition extends Visibility {
    ...
    public Animator onAppear(ViewGroup sceneRoot, final View view, TransitionValues startValues,
        ...
        double radius = calculateMaxRadius(view);
    ...
    public Animator onDisappear(ViewGroup sceneRoot, View view, TransitionValues startValues,
                                TransitionValues endValues) {
        double radius = calculateMaxRadius(view);
        return createAnimator(view, (float) radius, 0);
    }

    private Animator createAnimator(View view, float startRadius, double endRadius) {
